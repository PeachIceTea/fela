...
// recoverMiddleware returns a middleware that recovers from any panics and writes a 500
// if there was one.
			...
			if err := recover(); err != nil {
				...
				if brokenPipe {
					...
					c.AbortWithStatusJSON(
						...
						gin.H{"err": "internal server error"},
					)
				}
			}
		}()
...
func stack(skip int) []byte {
	...
	for i := skip; ; i++ { // Skip the expected number of frames
		...
		// Print this much at least.  If we can't find the source,
		// it won't show.
